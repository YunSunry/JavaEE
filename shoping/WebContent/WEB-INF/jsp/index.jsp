			...
			<div id="hotProduct" class="hotProduct clearfix">
					...
					<ul class="tab">
						...
						<c:forEach items="${hotList}" var="hotProduct">
									<li>
										<a target="_blank" href="${pageContext.request.contextPath}/productfindByPid?pid=${hotProduct.pid}"><img src="${pageContext.request.contextPath}/${hotProduct.image}"  style="display: block;"/></a>
									</li>
						</c:forEach>
						</ul>
		</div>
...
<!-- 					<div class="newProductAd">
						 ...
						 <c:forEach items="${newList}" var="newProduct">
								<li>
									<a  target="_blank" href="${pageContext.request.contextPath}/productfindByPid?pid=${newProduct.pid}"><img src="${pageContext.request.contextPath}/${newProduct.image}" style="display: block;"/></a>									
							    </li>
						</c:forEach>
						</ul>
		</div>
