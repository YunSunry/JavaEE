...
<body class="hold-transition skin-red sidebar-mini">
						...
						<table id="addOrEditTab"
							...
							<tr>
								...
								<td><input class="form-control" placeholder="份数"
									name="productNum" id="ebstatus"></td>
							</tr>
    ...
    productVO.productName = "${search.productName}"
    productVO.productPrice = "${search.productPrice}"
    productVO.productNum = "${search.productNum}"
    /*分页效果*/
    pagination(pageargs);
</script>
